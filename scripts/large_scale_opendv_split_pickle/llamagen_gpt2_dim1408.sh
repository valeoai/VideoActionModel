...
RUN_NAME='muP_GPT2_split_opendv_dim1408'
...
#SBATCH --job-name=muP_GPT2_split_opendv_dim1408_stage_${stage}
#SBATCH -C h100
#SBATCH -A ycy@h100
#SBATCH --nodes=24
#SBATCH --gres=gpu:4
...
srun python $TRAIN_SCRIPT \\
    ...
    optimizer.lr=$LR \\
    model.network.embedding_dim=1408 \\
    model.network.nb_heads=11 \\
    data.batch_size=4 \\
    data.num_workers=6 \\
