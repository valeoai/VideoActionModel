...
srun -A ycy@h100 -C h100 --pty --nodes=1 --ntasks-per-node=4 --cpus-per-task=10 --gres=gpu:4 --hint=nomultithread --qos=qos_gpu_h100-dev --time=00:10:00 \
python $SCRIPT_DIR/test_dataloading_ddp.py
