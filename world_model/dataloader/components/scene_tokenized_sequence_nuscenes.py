...
class SceneBasedNuscenesDataset(torch.utils.data.Dataset):
    ...
    This dataset class:
        ...
        - uses a pickle file, generated by the `gen_nuscenes_pickle.py` script, which contains structured
    ...
    def __init__(
        ...
        self.scenes = self._organize_scenes(nuscenes_pickle_data)
